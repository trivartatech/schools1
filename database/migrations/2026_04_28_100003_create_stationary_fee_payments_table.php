...
/**
 * Standalone receipts table for stationary fee collections.
 * Each row is an individual receipt with its own receipt_no generated
 * from the school's configurable stationary_receipt_* settings.
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('stationary_fee_payments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('stationary_fee_payments');
    }
};
