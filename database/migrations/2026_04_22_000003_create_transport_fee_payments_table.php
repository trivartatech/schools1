...
/**
 * Standalone receipts table for transport fee collections.
 * Each row is an individual receipt with its own receipt_no generated
 * from the school's configurable transport_receipt_* settings.
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('transport_fee_payments', function (Blueprint $table) {
            ...
            $table->foreignId('allocation_id')->constrained('transport_student_allocation')->cascadeOnDelete();
