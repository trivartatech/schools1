    ...
    <SchoolLayout title="Stationary Allocations">
        <div class="page-header">
            <div>
                ...
                <p class="page-header-sub">Assign stationary kits to students by class &amp; section.</p>
            </div>
        ...
        <div class="card">
            <div style="overflow-x: auto;">
                ...
                <div v-else style="text-align:center;padding:4rem 1rem;color:#9ca3af;">
                    ...
                    <p style="font-size:0.95rem;color:#475569;font-weight:500;">No allocations yet.</p>
                    <p style="font-size:0.82rem;color:#94a3b8;margin-top:0.25rem;">
                        <span v-if="can('create_stationary_allocations')">Click "+ New Allocation" to assign kits to a class.</span>
                    </p>
                </div>
            </div>
        ...
        <div v-if="showModal" class="modal-backdrop" @mousedown.self="showModal = false">
            <div class="modal" style="max-width: 44rem;">
                <div class="card-header" style="position: sticky; top: 0; background: var(--surface, #fff); z-index: 10; justify-content: space-between;">
                    <span class="card-title">📚 New Stationary Allocation</span>
