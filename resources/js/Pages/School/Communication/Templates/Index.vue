...
<template>
    <SchoolLayout :title="titleMap[type]">
        <PageHeader :title="titleMap[type]" subtitle="Manage external provider templates and mappings">
            <template #actions>
        ...
        <!-- List -->
        <div class="card">
            <Table :empty="templates.length === 0">
                <thead>
                    <tr>
                        <th>Name / Trigger</th>
                        <th>Template ID</th>
                ...
                <template #empty>
                    <EmptyState
                        :title="`No templates created for ${type}`"
                        description="Create your first template for this channel."
        ...
        <!-- Create/Edit Modal -->
        <Modal v-model:open="showModal" :title="`${editingTemplate ? 'Update' : 'Create'} Template`" size="lg">
            <form @submit.prevent="submit" id="template-form">
            ...
            <template #footer>
                ...
                <Button type="submit" form="template-form" :loading="form.processing">
