                ...
                <div v-show="loginMethod === 'email'">
                    <form class="space-y-6" @submit.prevent="submitEmail">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="password" v-model="emailForm.password" type="password" required class="appearance-none block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="••••••••" />
                            </div>
                        </div>
